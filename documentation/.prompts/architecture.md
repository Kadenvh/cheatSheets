...
4. If designing: store design doc in `documentation/plans/`
5. If writing ADR: store in `documentation/decisions/` (create if needed)
6. If reviewing: summarize findings with prioritized recommendations
